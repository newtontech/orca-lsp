...
- ORCA-E001: Unknown token in simple input line
- ORCA-E002: Unknown % block name
- ORCA-E003: Unclosed % block
- ORCA-E004: Duplicate % block
- ORCA-E005: Invalid charge value
- ORCA-E006: Invalid multiplicity value
- ORCA-E007: Multiplicity incompatible with charge
- ORCA-W001: Suggested %maxcore not set or value very low
- ORCA-W002: Non-standard token in simple input
- ORCA-W003: Duplicate token in simple input
- ORCA-W004: SCF maxiter out of typical range
- ORCA-W005: %pal nprocs unusually high
- ORCA-W020: Missing method or basis set in route line
- ORCA-E020: Malformed %pal block (missing or invalid nprocs)
- ORCA-E021: Missing charge/multiplicity in * xyz header
- ORCA-E022: Coordinate block not terminated with * or end
- ORCA-E023: Key block missing proper end terminator
- ORCA-E024: SCF convergence failure in ORCA output
- ORCA-E025: Input parse or runtime error in ORCA output

## OpenQC Compatibility

Status: PASSED
Checks: 5
  - rule_manifest: OK - 19 rules, 19 unique codes
  - lint_engine_valid: OK - 0 diagnostics on valid input
  - lint_engine_invalid: OK - 2 diagnostics on invalid input
  - validate_input: OK - valid=True
  - agent_api_snapshot: OK - uri=smoke://test
