...
# the optional fields they can evidence. ``diagnostic_engine`` keeps the legacy
# "1.0" label for existing consumers; ``diagnostic_envelope`` names the stable
# fleet contract so the parent probe can branch on it without breaking older
# readers.
